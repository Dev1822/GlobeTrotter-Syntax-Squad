...
env["GIT_AUTHOR_DATE"] = "2026-08-22 15:03:00 +0530"
env["GIT_COMMITTER_DATE"] = "2026-08-22 15:03:00 +0530"
subprocess.check_call(["git", "add", "."], env=env)
subprocess.check_call(["git", "commit", "-m", "chore: clean up build temporary scripts"], env=env)
