...
export const SharedTripPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F7F4EE] pb-24">
      {/* Hero Banner */}
      <div className="relative h-72 sm:h-96 w-full overflow-hidden bg-[#202525]">
        <img
          src={coverImage}
          alt={destination}
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 space-y-12">
        ...
        {activities.length > 0 && (
          <div className="bg-[#FFFFFF] p-8 sm:p-10 border border-[#E5E2E1] rounded-md shadow-xs space-y-6">
            ...
            <div className="relative pl-6 sm:pl-8 border-l-2 border-[#CBD5D6] space-y-6 mt-6">
              {activities.map((act, idx) => (
                <div key={idx} className="relative">
                  <div className="absolute -left-[31px] sm:-left-[39px] top-1.5 w-4 h-4 rounded-full bg-[#163A3D] border-4 border-[#FFFFFF]" />
                  <div className="p-4 bg-[#F6F3F2] rounded border border-[#E5E2E1] space-y-1">
                    <div className="flex items-center text-xs font-semibold text-[#163A3D]">
                      <Calendar className="w-3.5 h-3.5 mr-1" />
                      <span>
                        {act.date ? formatDate(act.date) : "Planned Stop"}
                      </span>
                    </div>
                    <h4 className="font-serif text-lg font-bold text-[#202525]">
                      {act.name}
                    </h4>
                    {act.location && (
                      <div className="flex items-center text-xs text-[#899596]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {accommodation?.name && (
            <div className="bg-[#FFFFFF] p-6 sm:p-8 border border-[#E5E2E1] rounded shadow-xs space-y-3">
              ...
              <div className="text-xs space-y-1 text-[#54433A] pt-2 border-t border-[#EDE7DF]">
                <p>
        ...
        {/* GlobeTrotter Promotion Banner */}
        <div className="p-8 sm:p-10 bg-[#202525] text-[#F7F4EE] rounded text-center shadow-lg">
