...
import TripStopsTab from "./tabs/TripStopsTab";
...
export const TripDetailPage = () => {
  ...
  if (error || !trip) {
    return (
      <div className="min-h-screen bg-[#F7F4EE] pt-28 pb-20 px-4 max-w-3xl mx-auto">
        <ErrorState
  ...
  return (
    <div className="min-h-screen bg-[#F7F4EE] pb-24">
      ...
      <section className="relative w-full h-[580px] sm:h-[680px] bg-[#202525] overflow-hidden">
        <div
        ...
        <div className="absolute top-24 left-4 sm:left-8 z-10">
          <Link
            to="/my-journey"
            className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-[#202525]/70 backdrop-blur-md text-xs font-semibold text-white hover:bg-[#163A3D] transition-colors border border-white/20"
          >
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="flex items-center space-x-2 px-5 py-2.5 rounded-full glass-panel-dark text-white hover:bg-white hover:text-[#202525] text-xs font-semibold transition-all duration-300 cursor-pointer"
              >
      ...
      <div className="sticky top-[73px] z-30 bg-[#F7F4EE]/95 backdrop-blur-md border-b border-[#CBD5D6]/40 px-4 sm:px-8 shadow-xs">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
        ...
        {activeTab === "stops" && <TripStopsTab trip={trip} onTripUpdated={setTrip} />}
        {activeTab === "itinerary" && (
      ...
      {isShareModalOpen && (
        ...
        >
          <div className="space-y-6">
            ...
            <div className="p-3 bg-[#F6F3F2] border border-[#CBD5D6] rounded flex items-center justify-between gap-2">
              <input
                type="text"
                readOnly
                value={shareLink}
                className="bg-transparent text-xs font-mono text-[#202525] w-full focus:outline-none"
              />
              <Button
                variant="terracotta"
                size="sm"
