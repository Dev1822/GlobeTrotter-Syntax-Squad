  ...
  return (
    <div className="space-y-12">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 py-6 border-y border-[#CBD5D6]/40 bg-[#FFFFFF] px-6 rounded shadow-xs">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-widest text-[#899596] mb-1">
              Duration
            </p>
            <p className="font-serif text-xl sm:text-2xl font-bold text-[#202525]">
              {calculateDays()}
            </p>
          </div>
          ...
          <div>
            ...
            <p className="font-serif text-xl sm:text-2xl font-bold text-[#163A3D] capitalize">
              {trip.status || "Planned"}
            </p>
          </div>
        </div>
      ...
      <section className="bg-[#F6F3F2] p-6 sm:p-8 rounded border border-[#CBD5D6]/40 shadow-xs">
        <div className="flex items-center space-x-2 mb-4 text-[#163A3D]">
        ...
        <div className="flex flex-col md:flex-row gap-6 md:items-center justify-between">
          <div className="space-y-2">
            <p className="text-xs font-semibold text-[#899596]">
              {nextActivity?.date
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Accommodation */}
        <div className="bg-[#FFFFFF] p-6 sm:p-8 border border-[#CBD5D6]/40 rounded shadow-xs space-y-4">
          <div className="flex items-center space-x-2 text-[#163A3D]">
          ...
          <div className="text-xs space-y-2 text-[#54433A] pt-2 border-t border-[#EDE7DF]">
            <p>
              <span className="text-[#899596] uppercase font-semibold block text-[10px]">
                Hotel / Heritage Haveli
              </span>
              <strong className="text-sm text-[#202525]">
