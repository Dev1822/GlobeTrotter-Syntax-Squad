    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="bg-[#FFFFFF] p-6 border border-[#E5E2E1] rounded shadow-xs">
          ...
          <p className="font-serif text-2xl font-bold text-[#202525] mt-1">
        ...
        <div className="bg-[#FFFFFF] p-6 border border-[#E5E2E1] rounded shadow-xs">
          ...
          <p className="font-serif text-2xl font-bold text-[#163A3D] mt-1">
            ₹{totalSpent.toLocaleString("en-IN")}
          </p>
          <div className="w-full bg-[#EDE7DF] h-1.5 rounded-full mt-2 overflow-hidden">
            <div
              className={`h-full ${
                percentUsed > 100 ? "bg-[#BA1A1A]" : "bg-[#163A3D]"
              }`}
        ...
        <div className="bg-[#FFFFFF] p-6 sm:p-8 border border-[#E5E2E1] rounded shadow-xs space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {summary.map((item, idx) => (
              ...
              >
                <span className="text-[11px] font-semibold uppercase tracking-wider text-[#899596] truncate">
                  {item.category}
                </span>
                <span className="font-serif text-lg font-bold text-[#202525] mt-1">
