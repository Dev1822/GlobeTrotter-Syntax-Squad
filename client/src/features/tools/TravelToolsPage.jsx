    ...
    <div className="min-h-screen bg-[#F7F4EE] pt-28 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#163A3D] mb-2 block">
            Field Utilities
          </span>
          <h1 className="font-serif text-4xl sm:text-5xl font-bold text-[#202525]">
            Travel Tools
          </h1>
        ...
        <div className="flex justify-center mb-12">
          <div className="inline-flex p-1 bg-[#EDE7DF] rounded border border-[#CBD5D6]/60">
            <button
              type="button"
              ...
              className={`flex items-center space-x-2 px-6 py-2 text-xs font-semibold uppercase tracking-wider rounded transition-all ${
                activeTab === "translator"
                  ? "bg-[#FFFFFF] text-[#163A3D] shadow-sm"
                  : "text-[#54433A] hover:text-[#202525]"
              }`}
            >
        ...
        {activeTab === "translator" && (
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-[#FFFFFF] border border-[#CBD5D6] rounded-md shadow-sm p-6 sm:p-8 space-y-6">
              {/* Language Selection Header */}
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pb-4 border-b border-[#EDE7DF]">
                <div className="w-full sm:w-5/12">
                  <label className="block text-[11px] font-semibold uppercase tracking-wider text-[#899596] mb-1">
                    Source Language
                  </label>
                  <select
                    value={sourceLang}
                    onChange={(e) => setSourceLang(e.target.value)}
                    className="w-full py-2 px-3 bg-[#F6F3F2] border border-[#CBD5D6] rounded text-xs font-semibold text-[#202525] focus:outline-none focus:border-[#163A3D]"
                  >
                ...
                <button
                  ...
                  className="p-2 rounded-full border border-[#CBD5D6] text-[#163A3D] hover:bg-[#FFDBC9] disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col space-y-2">
                  <textarea
                    ...
                    className="w-full p-4 bg-[#F7F4EE] border border-[#CBD5D6] rounded text-sm text-[#202525] placeholder-[#899596]/70 focus:outline-none focus:border-[#163A3D] resize-y"
                    maxLength={5000}
                  />
                  <div className="flex justify-between text-[11px] text-[#899596]">
                    {detectedLang && (
                ...
                <div className="flex flex-col space-y-2 relative">
                  <div className="w-full p-4 bg-[#F6F3F2] border border-[#E5E2E1] rounded min-h-[160px] text-sm text-[#202525] font-serif leading-relaxed">
                    {translatedText ? (
                      translatedText
                    ) : (
                      <span className="text-[#899596] font-sans text-xs italic">
                  ...
                  {translatedText && (
                    <div className="flex justify-end">
                      <button
                        ...
                        className="inline-flex items-center space-x-1 text-xs font-semibold text-[#163A3D] hover:underline"
                      >
                        {copied ? (
                          <>
        ...
        {activeTab === "weather" && (
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <form
              ...
              className="bg-[#FFFFFF] p-4 border border-[#CBD5D6] rounded-md shadow-sm flex flex-col sm:flex-row gap-3"
            >
              <div className="relative flex-1 flex items-center px-2">
                <Search className="w-4 h-4 text-[#899596] mr-2" />
                <input
                  type="text"
                  value={weatherQuery}
                  onChange={(e) => setWeatherQuery(e.target.value)}
                  placeholder="Enter destination city (e.g. Udaipur, Agra, Munnar, Leh, Goa)..."
                  className="w-full text-sm text-[#202525] placeholder-[#899596] focus:outline-none bg-transparent"
                />
              </div>
            ...
            {weatherLoading ? (
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#FFFFFF] p-8 sm:p-10 border border-[#CBD5D6] rounded-md shadow-sm flex flex-col sm:flex-row items-center justify-between gap-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 w-full sm:w-auto">
                    <div className="p-3.5 bg-[#F6F3F2] rounded border border-[#E5E2E1]">
                      ...
                      <p className="font-serif text-lg font-bold text-[#202525]">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                      {forecast.slice(0, 10).map((item, idx) => (
                        ...
                        >
                          <span className="text-[11px] font-semibold text-[#899596]">
                            {item.date
                          ...
                          <div className="font-serif text-base font-bold text-[#202525]">
        ...
        {activeTab === "currency" && (
          <div className="max-w-xl mx-auto">
            <div className="bg-[#FFFFFF] p-8 sm:p-10 border border-[#CBD5D6] rounded-md shadow-sm space-y-6">
              <span className="text-xs font-semibold uppercase tracking-[0.15em] text-[#163A3D] block">
              ...
              <div className="pt-6 border-t border-[#EDE7DF] bg-[#F6F3F2] p-6 rounded text-center">
                <span className="text-xs uppercase font-semibold text-[#899596]">
                  Converted Estimated Value
                </span>
                <p className="font-serif text-3xl sm:text-4xl font-extrabold text-[#163A3D] mt-1">
                  {ratesLoading
                    ? "Calculating rates..."
                    : convertedResult
                ...
                <p className="text-[10px] text-[#899596] mt-2">
