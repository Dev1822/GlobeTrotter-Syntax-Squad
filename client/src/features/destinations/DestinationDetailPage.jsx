    ...
    <div className="bg-[#F7F4EE] text-[#202525] min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 py-24 sm:py-32 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8">
          ...
          <div className="md:col-span-8 group cursor-pointer relative h-[480px] overflow-hidden rounded bg-[#202525] image-zoom shadow-sm">
            <img
          ...
          <div className="md:col-span-4 group cursor-pointer relative h-[480px] overflow-hidden rounded bg-[#202525] image-zoom shadow-sm">
            <img
            ...
            <div className="absolute bottom-0 left-0 p-8 text-white space-y-2">
              ...
              <p className="text-sm text-[#F7F4EE]/90 leading-relaxed">
          ...
          <div className="md:col-span-6 group cursor-pointer relative h-[380px] overflow-hidden rounded bg-[#202525] image-zoom shadow-sm">
            <img
        ...
        <div className="w-full h-[500px] rounded overflow-hidden shadow-sm border border-[#CBD5D6]/40 bg-[#EDE7DF]">
          <iframe
            ...
            src={`https://www.openstreetmap.org/export/embed.html?bbox=${
              name === 'Udaipur' ? '73.66%2C24.56%2C73.72%2C24.60' : '70.0%2C10.0%2C90.0%2C30.0'
            }&layer=mapnik&marker=${
              name === 'Udaipur' ? '24.58%2C73.69' : '20.0%2C80.0'
            }`}
            allowFullScreen
          ></iframe>
        </div>
