...
export const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F7F4EE] pt-28 pb-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="border-b border-[#E5E2E1] pb-6">
          ...
          <h1 className="font-serif text-4xl font-bold text-[#202525]">
            Profile & Settings
          </h1>
        ...
        <div className="bg-[#FFFFFF] p-8 sm:p-10 border border-[#CBD5D6] rounded-md shadow-xs space-y-6">
          <div className="flex items-center justify-between">
            <h3 className="font-serif text-2xl font-bold text-[#202525] flex items-center">
              <User className="w-5 h-5 mr-2.5 text-[#163A3D]" />
            ...
            <div className="pt-2">
              ...
              <div className="flex items-center justify-between p-3 bg-[#F6F3F2] border border-[#E5E2E1] rounded text-xs">
                ...
                <button
                  ...
                  className="font-semibold text-[#163A3D] hover:underline"
                >
                  Change Email (OTP)
                </button>
              </div>
              {otpStatus?.tempEmail && (
                <p className="text-[11px] text-[#163A3D] mt-1.5 flex items-center">
        ...
        <div className="bg-[#FFFFFF] p-8 sm:p-10 border border-[#CBD5D6] rounded-md shadow-xs space-y-6">
          <h3 className="font-serif text-2xl font-bold text-[#202525] flex items-center">
            <KeyRound className="w-5 h-5 mr-2.5 text-[#163A3D]" />
            Security & Password
          </h3>
