...
export const LoginPage = () => {
  ...
  return (
    <div className="bg-[#F7F4EE] text-[#202525] min-h-screen flex flex-col md:flex-row antialiased selection:bg-[#FFDBC9] selection:text-[#321200] pt-16 md:pt-0">
      ...
      <div className="hidden md:flex w-1/2 relative bg-[#E5E2E1] overflow-hidden group min-h-screen">
        ...
        <div className="absolute bottom-16 left-16 text-white flex flex-col gap-2 z-10 max-w-md">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#E8895B]">
            Featured Sanctuary
          </p>
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-6 sm:px-12 lg:px-20 py-16 md:py-24 relative bg-[#F7F4EE]">
        <div className="max-w-md mx-auto w-full flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <h1 className="font-serif text-3xl sm:text-4xl font-bold text-[#202525]">
              Return to your journey
            </h1>
            <p className="text-sm sm:text-base text-[#54433A]">
              Log in to your GlobeTrotter account to access your saved itineraries and
              tools.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <label
                  className="block text-xs font-semibold uppercase tracking-wider text-[#899596]"
                ...
                <Link
                  to="/forgot-password"
                  className="text-xs text-[#163A3D] hover:underline font-medium"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#163A3D] text-white text-xs font-semibold uppercase tracking-widest py-4 px-8 rounded flex items-center justify-center gap-2 hover:bg-[#204F53] transition-colors duration-300 shadow-sm disabled:opacity-50 mt-2 cursor-pointer"
            >
          ...
          <div className="relative flex items-center py-1">
            <div className="flex-grow border-t border-[#CBD5D6]/40" />
            <span className="flex-shrink-0 mx-4 text-xs font-semibold text-[#899596] uppercase tracking-wider">
              or
            </span>
            <div className="flex-grow border-t border-[#CBD5D6]/40" />
          </div>
          ...
          <div className="pt-2 text-center text-xs text-[#54433A]">
            ...
            <Link
              to="/register"
              className="font-semibold text-[#163A3D] hover:underline ml-1"
            >
              Create Account
            </Link>
          </div>
