          ...
          <div className="text-center py-4 space-y-4">
            ...
            <div className="pt-4">
              <button
                ...
                className="w-full bg-[#163A3D] text-white py-3.5 px-6 rounded text-xs font-semibold uppercase tracking-widest hover:bg-[#204F53] transition-colors cursor-pointer"
              >
                Go to My Journeys
              </button>
            </div>
          ...
          <div className="space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-[#54433A]">
                Choose a strong password for your GlobeTrotter account.
              </p>
            </div>
