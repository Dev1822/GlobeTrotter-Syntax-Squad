    ...
    <div className="bg-[#F7F4EE] text-[#202525] min-h-screen">
      ...
      <section className="relative min-h-[60vh] flex items-center px-4 sm:px-8 lg:px-16 pt-32 pb-24 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#F7F4EE] via-[#F7F4EE]/80 to-transparent" />
        </div>

        {/* Hero Content */}
        <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-12">
          <div className="md:col-span-8 space-y-4">
            <h1 className="font-serif text-5xl sm:text-7xl lg:text-8xl font-bold text-[#163A3D] leading-tight">
              How can we help?
            </h1>
            <p className="text-lg sm:text-xl text-[#54433A] max-w-2xl font-normal leading-relaxed">
              Have a question about GlobeTrotter or your journey? We're here to help.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-8 lg:px-16 py-20 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
          ...
          <div className="lg:col-span-6">
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-[#163A3D] mb-8 border-b border-[#CBD5D6]/30 pb-4">
              Help
            </h2>

            <div className="space-y-1 divide-y divide-[#CBD5D6]/30">
              {faqs.map((faq, idx) => {
                ...
                return (
                  <div key={idx} className="py-6 cursor-pointer">
                    ...
                    >
                      <h3 className="font-serif text-2xl font-semibold text-[#202525] group-hover:text-[#163A3D] transition-colors">
                        {faq.q}
                      </h3>
                      <ChevronDown
                        className={`w-5 h-5 text-[#899596] group-hover:text-[#163A3D] transition-transform duration-300 ${
                          isOpen ? "rotate-180" : ""
                        }`}
                      />
                    </div>
                    ...
                    {isOpen && (
                      <div className="pt-4 text-base text-[#54433A] leading-relaxed font-sans animate-fade-in-up">
                        <strong className="text-[#202525] block mb-1">
                          {faq.title}
                        </strong>
                        <p>{faq.answer}</p>
                      </div>
            ...
            {/* Direct Contact */}
            <div className="mt-16 pt-8 border-t border-[#CBD5D6]/30">
              <h4 className="text-xs font-semibold text-[#899596] uppercase tracking-widest mb-2">
                Need help with your journey?
              </h4>
              <a
                className="font-serif text-3xl font-bold text-[#163A3D] hover:text-[#204F53] transition-colors inline-flex items-center gap-2"
          ...
          <div className="lg:col-span-6 relative">
            <div className="lg:sticky lg:top-32">
              ...
              {submitted ? (
                <div className="py-12 bg-white/70 p-8 rounded border border-[#CBD5D6]/40 text-center space-y-4 shadow-xs">
                  ...
                  <button
                    ...
                    className="mt-6 px-8 py-3 bg-[#202525] text-white rounded text-xs font-semibold uppercase tracking-wider hover:bg-[#163A3D] transition-colors"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-10">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Name"
                      className="w-full bg-transparent border-0 border-b border-[#CBD5D6] py-3 text-lg text-[#202525] placeholder-[#899596]/60 focus:ring-0 focus:border-[#163A3D] transition-colors"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-transparent border-0 border-b border-[#CBD5D6] py-3 text-lg text-[#202525] placeholder-[#899596]/60 focus:ring-0 focus:border-[#163A3D] transition-colors resize-none"
                    />
                  </div>
                  ...
                  <div className="pt-4">
                    <button
                      type="submit"
                      className="bg-[#202525] text-[#F7F4EE] px-10 py-4 text-base font-normal border border-[#202525] hover:bg-[#163A3D] hover:border-[#163A3D] transition-all duration-300 w-full sm:w-auto text-center inline-flex items-center justify-center gap-2 group cursor-pointer"
                    >
      ...
      {/* ── 3. FINAL CTA ── */}
      <section className="px-4 sm:px-8 lg:px-16 py-24 border-t border-[#CBD5D6]/20 text-center">
        <div className="max-w-2xl mx-auto space-y-6">
          <h2 className="font-serif text-4xl sm:text-6xl font-bold text-[#163A3D]">
            Ready to keep exploring?
          </h2>
          <div className="pt-2">
            <Link
              to="/explore"
              className="inline-flex items-center gap-2 bg-[#202525] text-white px-10 py-4 text-base font-normal border border-[#202525] hover:bg-[#163A3D] hover:border-[#163A3D] transition-all duration-300 group cursor-pointer"
            >
