...
export const NotFoundPage = () => {
  return (
    <div className="bg-[#F7F4EE] text-[#202525] min-h-screen flex items-center pt-28 pb-20">
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-8 lg:px-16 grid grid-cols-1 md:grid-cols-12 gap-12 items-center min-h-[65vh]">
        ...
        <div className="md:col-span-5 flex flex-col justify-center order-2 md:order-1 z-10">
          <div className="w-12 h-[2px] bg-[#CBD5D6] mb-8" />
          <span className="text-xs font-semibold uppercase tracking-[0.25em] text-[#163A3D] block mb-3">
            404 · PAGE NOT FOUND
          </span>
          <h1 className="font-serif text-4xl sm:text-6xl font-bold text-[#202525] mb-6 leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              to="/explore"
              className="bg-[#163A3D] text-white px-8 py-4 rounded text-xs font-semibold uppercase tracking-widest text-center hover:bg-[#204F53] transition-colors duration-300 flex items-center justify-center gap-2 group"
            >
            ...
            <Link
              to="/"
              className="border border-[#CBD5D6] text-[#202525] px-8 py-4 rounded text-xs font-semibold uppercase tracking-widest text-center hover:bg-[#F6F3F2] transition-colors duration-300"
            >
              Go Home
            </Link>
          </div>
        ...
        <div className="md:col-span-7 h-[45vh] md:h-[70vh] w-full relative rounded overflow-hidden order-1 md:order-2 group shadow-sm">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#202525]/30 via-transparent to-transparent pointer-events-none" />
        </div>
      </div>
    </div>
  );
