...
export const HowItWorksPage = () => {
  return (
    <div className="bg-[#F7F4EE] text-[#202525] overflow-x-hidden min-h-screen">
      {/* ── 1. HERO SECTION ── */}
      <section className="relative w-full h-[88vh] min-h-[580px] flex items-end pb-20 md:pb-28">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 w-full text-white">
          <div className="max-w-3xl">
            <span className="text-xs font-semibold uppercase tracking-[0.25em] text-[#E8895B] block mb-3">
      ...
      <section className="py-24 sm:py-32 max-w-7xl mx-auto px-4 sm:px-8 lg:px-16">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20 mb-28 sm:mb-36">
          <div className="w-full md:w-5/12">
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#163A3D] mb-3 block">
              01 / DISCOVER
            </span>
            <h2 className="font-serif text-3xl sm:text-5xl font-bold text-[#202525] mb-5">
          ...
          <div className="w-full md:w-7/12 relative aspect-[4/3] overflow-hidden bg-[#F6F3F2] rounded border border-[#899596]/10 p-3 sm:p-4 image-zoom shadow-sm">
            <img
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full md:w-7/12 relative aspect-[16/10] overflow-hidden bg-[#F6F3F2] rounded border border-[#899596]/10 p-3 sm:p-4 image-zoom shadow-sm">
            <img
              className="w-full h-full object-cover rounded"
      ...
      <section className="bg-[#F6F3F2] py-24 sm:py-32 border-y border-[#CBD5D6]/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          <div className="flex flex-col items-center text-center p-6 bg-white/70 rounded border border-[#CBD5D6]/30 group hover:border-[#163A3D]/40 transition-colors">
            <div className="w-16 h-16 rounded-full bg-[#EDE7DF] flex items-center justify-center mb-5 group-hover:scale-105 group-hover:bg-[#FFDBC9] transition-all duration-300">
              <Calendar className="w-6 h-6 text-[#163A3D]" />
            </div>
            <span className="text-xs font-semibold uppercase tracking-widest text-[#202525]">
              Itinerary
            </span>
          </div>
          ...
          <div className="flex flex-col items-center text-center p-6 bg-white/70 rounded border border-[#CBD5D6]/30 group hover:border-[#163A3D]/40 transition-colors">
            <div className="w-16 h-16 rounded-full bg-[#EDE7DF] flex items-center justify-center mb-5 group-hover:scale-105 group-hover:bg-[#FFDBC9] transition-all duration-300">
              <MapPin className="w-6 h-6 text-[#163A3D]" />
            </div>
            <span className="text-xs font-semibold uppercase tracking-widest text-[#202525]">
              Places
            </span>
          ...
          <div className="flex flex-col items-center text-center p-6 bg-white/70 rounded border border-[#CBD5D6]/30 group hover:border-[#163A3D]/40 transition-colors">
            <div className="w-16 h-16 rounded-full bg-[#EDE7DF] flex items-center justify-center mb-5 group-hover:scale-105 group-hover:bg-[#FFDBC9] transition-all duration-300">
              <DollarSign className="w-6 h-6 text-[#163A3D]" />
            </div>
            <span className="text-xs font-semibold uppercase tracking-widest text-[#202525]">
              Budget & Expenses
            </span>
          ...
          <div className="flex flex-col items-center text-center p-6 bg-white/70 rounded border border-[#CBD5D6]/30 group hover:border-[#163A3D]/40 transition-colors">
            <div className="w-16 h-16 rounded-full bg-[#EDE7DF] flex items-center justify-center mb-5 group-hover:scale-105 group-hover:bg-[#FFDBC9] transition-all duration-300">
              <Luggage className="w-6 h-6 text-[#163A3D]" />
            </div>
            <span className="text-xs font-semibold uppercase tracking-widest text-[#202525]">
              Packing Checklist
            </span>
      ...
      <section className="py-24 sm:py-32 max-w-4xl mx-auto px-4 sm:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Link
            to="/explore"
            className="px-8 py-4 bg-[#163A3D] text-white rounded text-xs font-semibold uppercase tracking-widest hover:bg-[#204F53] transition-colors duration-300 inline-flex items-center justify-center gap-2"
          >
          ...
          <Link
            to="/register"
            className="px-8 py-4 bg-transparent text-[#163A3D] rounded text-xs font-semibold uppercase tracking-widest border border-[#163A3D] hover:bg-[#163A3D]/5 transition-colors duration-300 inline-flex items-center justify-center"
          >
            Get Started
          </Link>
        </div>
