...
export const HomePage = () => {
  return (
    <div className="bg-[#F7F4EE] text-[#202525] overflow-x-hidden">
      ...
      <header className="relative w-full h-[75vh] min-h-[500px] flex items-end pb-16 md:pb-24 px-4 sm:px-8 lg:px-16">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full text-white">
          <div className="max-w-3xl space-y-4">
            <p className="text-xs font-semibold uppercase tracking-[0.25em] text-[#E8895B]">
              UDAIPUR · RAJASTHAN
            </p>
            <h1 className="font-serif text-4xl sm:text-6xl lg:text-7xl font-bold leading-[1.1] tracking-tight">
              Your next journey starts here.
            </h1>
            <p className="text-sm sm:text-lg text-[#F7F4EE]/90 max-w-xl font-normal leading-relaxed pt-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <Link
                to="/explore"
                className="bg-[#F7F4EE] text-[#202525] px-8 py-4 rounded text-xs font-semibold uppercase tracking-[0.15em] text-center hover:bg-[#EDE7DF] hover:-translate-y-0.5 transition-all duration-300 shadow-md"
              >
      ...
      >
        <div className="mb-14 sm:mb-20 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="max-w-2xl">
            ...
            <p className="text-sm sm:text-base text-[#525A5A] mt-2">
          ...
          <Link
            ...
            className="inline-flex items-center space-x-2 text-xs font-semibold uppercase tracking-wider text-[#163A3D] hover:text-[#204F53] group"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8">
          ...
          <Link
            ...
            className="group md:col-span-8 relative aspect-[16/10] md:aspect-[4/3] overflow-hidden rounded bg-[#EDE7DF] image-zoom block shadow-sm"
          >
            <img
            ...
            <div className="absolute bottom-0 left-0 p-6 sm:p-10 w-full text-white">
              <p className="text-xs font-semibold uppercase tracking-widest text-[#E8895B] mb-1.5">
                Rajasthan
              </p>
          ...
          <Link
            ...
            className="group md:col-span-4 relative aspect-[4/5] md:aspect-auto md:h-full overflow-hidden rounded bg-[#EDE7DF] image-zoom block shadow-sm"
          >
            <img
          ...
          <Link
            ...
            className="group md:col-span-4 relative aspect-[4/5] overflow-hidden rounded bg-[#EDE7DF] image-zoom block shadow-sm"
          >
            <img
      ...
      <section className="bg-[#F6F3F2] py-24 sm:py-32 px-4 sm:px-8 lg:px-16 border-y border-[#CBD5D6]/30">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="font-serif text-3xl sm:text-5xl font-bold text-[#202525] max-w-3xl mx-auto mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
            <div className="group text-center space-y-4">
              <p
                aria-hidden="true"
                className="font-serif text-6xl font-light text-[#899596]/60 group-hover:text-[#163A3D] transition-colors duration-500"
              >
                01
              </p>
              ...
              <p className="text-xs sm:text-sm text-[#525A5A] max-w-xs mx-auto leading-relaxed">
      ...
      >
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="font-serif text-3xl sm:text-5xl font-bold text-[#202525] mb-4">
            How it works
          </h2>
          <p className="text-sm sm:text-base text-[#525A5A]">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
            <div className="w-full lg:w-1/2 order-2 lg:order-1">
              <div className="max-w-md ml-auto space-y-4">
                <span className="text-xs font-semibold uppercase tracking-widest text-[#163A3D]">
                  01
                </span>
                <h3 className="font-serif text-3xl sm:text-4xl font-bold text-[#202525]">
                  Discover
                </h3>
                <p className="text-xs sm:text-sm text-[#525A5A] leading-relaxed">
            ...
            <div className="w-full lg:w-1/2 order-1 lg:order-2">
              <div className="aspect-[4/3] w-full overflow-hidden rounded bg-[#EDE7DF] shadow-md">
                <img
      ...
      <section className="relative py-32 md:py-48 px-4 sm:px-8 lg:px-16 flex items-center justify-center text-center">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-white space-y-6">
          ...
          <div className="pt-4">
            <Link
              to="/explore"
              className="inline-block bg-[#F7F4EE] text-[#202525] px-10 py-4.5 rounded text-xs font-semibold uppercase tracking-[0.15em] hover:bg-[#EDE7DF] hover:-translate-y-0.5 transition-all duration-300 shadow-xl"
            >
              Explore Destinations
            </Link>
          </div>
