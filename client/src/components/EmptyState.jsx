...
export const EmptyState = ({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center p-12 text-center bg-[#FFFFFF]/60 border border-dashed border-[#CBD5D6] rounded-md my-6 ${className}`}
    >
      <div className="w-14 h-14 rounded-full bg-[#FFDBC9]/50 flex items-center justify-center text-[#163A3D] mb-4">
