/**
 * Email templates helper for GlobeTrotter
...
<head>
  ...
  <title>Email Verification - GlobeTrotter</title>
  <style>
    body {
    ...
    .expiry strong {
      color: #ff6e40; /* GlobeTrotter Coral secondary accent */
    }
    .divider {
      height: 1px;
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="footer">
        If you did not make this request on GlobeTrotter, please safely ignore this email. Your account credentials remain fully secure.
      </div>
    </div>
  </div>
</body>
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Reset Password - GlobeTrotter</title>
  <style>
    body {
      font-family: "Poppins", "Roboto", "Helvetica Neue", Helvetica, Arial, sans-serif;
      background-color: #f5f7fa;
    ...
    .expiry strong {
      color: #ff6e40; /* GlobeTrotter Coral accent */
    }
    .divider {
      height: 1px;
      background-color: rgba(63, 81, 181, 0.08);
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="greeting">Hi ${name || "Traveler"},</div>
      <div class="message">
        You requested a password reset for your GlobeTrotter account. Click the button below to establish a new password and secure your credentials.
      </div>
